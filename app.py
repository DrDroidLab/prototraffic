...
def PlaceOrder():
	...
	if request.method == 'POST':
		...
		dr.publish("OrderAllocation", "Initiated", {'order_id': order_id, 'city': city, 'merchant_id': merchant_id, 'order_value': int(order_value), 'pickup_location': pickup_location, 'drop_location': drop_location})
